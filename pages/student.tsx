...
const StudentHomepage = () => {
  ...
  const loadUserData = async (userId: string) => {
    ...
    if (typeof window !== 'undefined') {
      localStorage.removeItem('studentTickets');
      localStorage.removeItem('studentActiveTickets');
      localStorage.removeItem('studentClosedTickets');
      localStorage.removeItem('studentSelectedTicket');
    }
